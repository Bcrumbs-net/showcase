...
import SaasModerFeatureSection from "../../../lib/organisms/components/featuresLists/featureList20";
import SaasWorkingProcessSection from "../../../lib/organisms/components/featuresLists/featureList21";
import SaasInfoProcessSection from "../../../lib/organisms/components/featuresLists/featureList22";
...
const resolveComponents = () => {
  return {
    ...
    403222: {
      render: (props) => <SaasModerFeatureSection {...props} />,
      name: "SaaS Modern Feature List",
      category: "Feature Listing",
    },
    403208: {
      render: (props) => <SaasWorkingProcessSection {...props} />,
      name: "SaaS Working Process Section",
      category: "Feature Listing",
    },
    403565: {
      render: (props) => <SaasInfoProcessSection {...props} />,
      name: "SaaS Info Section",
      category: "Feature Listing",
    },
  };
};
